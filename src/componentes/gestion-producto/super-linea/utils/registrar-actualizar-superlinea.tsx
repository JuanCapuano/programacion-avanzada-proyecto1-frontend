...
import {
  FormValuesSuperlinea,
  schemaSuperlinea,
  transformDataSuperlinea,
...
export default function RegistrarActualizarSuperlineaForm({
  ...
  const methods = useForm<FormValuesSuperlinea>({
    resolver: yupResolver(schemaSuperlinea) as any,
    defaultValues: superlinea ? transformDataSuperlinea(superlinea) : {},
  });
  ...
  const onSubmit = async (formData: FormValuesSuperlinea) => {
